...
var calculateSlot__default = /*#__PURE__*/_interopDefault(calculateSlot);
...
// src/RedisScanManager.ts
var log = debug__default.default("redis-scan-manager");
var RedisScanManager = class {
  ...
  _getNode(key) {
    ...
    const slot = calculateSlot__default.default(key);
